...
public class PosController {
    ...
    @FXML private TableColumn<TransactionItem, String> colCartName;
    @FXML private TableColumn<TransactionItem, Integer> colCartQty;
    @FXML private TableColumn<TransactionItem, Double> colCartPrice;
    @FXML private TableColumn<TransactionItem, Double> colCartTotal;
    ...
    public void initialize() {
        ...
        colCartTotal.setCellValueFactory(cellData -> 
            new SimpleDoubleProperty(cellData.getValue().getQuantity() * cellData.getValue().getPriceAtSale()).asObject());
    ...
    private void handleCheckout() {
        ...
        Transaction transaction = new Transaction(0, 
                ...
                total, "Admin"); // Hardcoded cashier for now
